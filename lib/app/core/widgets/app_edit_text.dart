      ...
      children: [
        ...
        TextFormField(
          ...
          validator: (value) {
            ...
            if (value == null || value == "") {
              return isFilePicker
                  ? pleaseProvideTheRequiredInformation.tr
                  : errorMsg ?? enterAValue.tr;
              ...
              if (!phoneNumberRegex.hasMatch(value)) {
                return invalidMobileNumber ?? invalidMobileText.tr;
              }
              ...
              if (!emailRegex.hasMatch(value)) {
                return invalidEmailMsg ?? invalidEmailText.tr;
              }
            } else if (isBangla) {
